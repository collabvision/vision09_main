...
const Square = forwardRef(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-28 flex-col items-center justify-center gap-2 rounded-2xl border-2 bg-white p-4 text-center shadow-[0_0_25px_-10px_rgba(0,0,0,0.6)] transition hover:scale-105 hover:shadow-xl",
        className
      )}
    >
      {children}
...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[550px] w-full items-center justify-center overflow-hidden p-10"
      ref={containerRef}
    >

      <div className="flex size-full max-h-[320px] max-w-xl flex-col items-stretch justify-between gap-16">

        {/* ROW 1 */}
        <div className="flex flex-row items-center justify-between">
          <Square ref={div1Ref}>
            <Target size={34} />
            <span className="text-base font-semibold">Strategy</span>
          </Square>

          <Square ref={div5Ref}>
            <Briefcase size={34} />
            <span className="text-base font-semibold">Expertise</span>
          </Square>
        </div>
        ...
        <div className="flex flex-row items-center justify-between">
          <Square ref={div2Ref}>
            <ShieldCheck size={34} />
            <span className="text-base font-semibold">Standards</span>
          </Square>

          <Square ref={div4Ref} className="size-32">
            <Settings size={40} />
            <span className="text-lg font-bold">Execution</span>
          </Square>
        ...
        <div className="flex flex-row items-center justify-between">
          <Square ref={div3Ref}>
            <Eye size={34} />
            <span className="text-base font-semibold">Transparency</span>
          </Square>
