...
:root{
  ...
  --gold-border:rgba(200,169,81,0.35);
...
export default function AboutPage(){
  ...
  useEffect(()=>{
    const cur=curRef.current, ring=ringRef.current; if(!cur||!ring) return
    ...
    document.querySelectorAll("a,button,.f-card,.vm-card,.diff-row").forEach(el=>{
  ...
  const tickers=["Strategy","Branding","Performance Marketing","Content Systems","Growth","Social Media","Influencer Marketing","Website Design"]
  ...
  return(<>
    ...
    <section className="hero">
      ...
      <p className="hero-eyebrow"><span/>Strategic Marketing &amp; Brand Communication<span/></p>
      <h1 className="hero-title">
        <span className="ln ln1">WHO</span>
        <span className="ln ln2">WE</span>
        <span className="ln ln3">ARE</span>
      </h1>
      <p className="hero-sub">In a space where everyone is creating content, we focus on building systems that convert—combining strategy, creativity, performance marketing, and execution to deliver real business impact.</p>
      <div className="hero-badge"><div className="yr">2024</div><div className="est">Est. · Pune, India</div></div>
      <div className="ticker-wrap">
        <div className="ticker-track">
          {[...tickers,...tickers].map((t,i)=><div key={i} className="t-item">{t}<span className="t-diamond"/></div>)}
        </div>
      </div>
    </section>
    ...
    <section className="story">
      <div className="story-left rv">
        ...
        <h2 className="story-h">Marketing should drive <em>results,</em> not just visibility.</h2>
      </div>
      <div>
        ...
        ].map((p,i)=><p key={i} className={`body-txt rv d${i+1}`}>{p}</p>)}
      </div>
    </section>
    ...
    <section className="vm-section">
      <div className="rv"><div className="sec-eyebrow">02 — Direction</div>
        <h2 style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(1.8rem,4vw,3.2rem)",fontWeight:600,lineHeight:1.2,maxWidth:500}}>
          Where we're headed &amp; <em style={{color:"var(--gold)",fontStyle:"italic"}}>why it matters</em></h2>
      </div>
      <div className="vm-grid">
        {[{tag:"Vision",title:"BUILD TO SCALE",text:"To build brands that scale sustainably through strategic thinking, strong brand systems, and performance-driven execution."},
          {tag:"Mission",title:"MEASURE EVERYTHING",text:"To help businesses generate measurable growth by combining strategy, creativity, performance marketing, and consistent execution across digital and offline channels."}
        ].map((c,i)=>(
    ...
    <section className="founders">
      <div className="rv"><div className="sec-eyebrow">03 — The People</div>
        <h2 style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(1.8rem,4vw,3.2rem)",fontWeight:600,lineHeight:1.2}}>
          Driven by a young, <em style={{color:"var(--gold)",fontStyle:"italic"}}>dynamic team</em></h2>
      </div>
      <p className="intro-txt rv d1">Strategists, creatives, marketers, editors, designers, and campaign managers who work together with a shared focus on quality and results. Creative thinking meets data-backed execution.</p>
      <div className="f-grid">
        {[{n:"01",name:"OM SHETTI",role:"Co-Founder · Performance",
            ...
            focus:'"Marketing isn\'t about posting. It\'s about building systems that convert."',d:"d1"},
          {n:"02",name:"SANYAM KALMANI",role:"Co-Founder · R&D",
            ...
            focus:'"Engineer growth built to last."',d:"d2"},
          {n:"03",name:"MURAD MADARSHA",role:"Co-Founder · Creative",
            ...
            focus:'"Every post has one job: make the brand remembered."',d:"d3"},
        ].map((f,i)=>(
    ...
    <section className="diff">
      <div className="rv"><div className="sec-eyebrow">04 — What Sets Us Apart</div>
        <h2 style={{fontFamily:"'Playfair Display',serif",fontSize:"clamp(1.8rem,4vw,3.2rem)",fontWeight:600,lineHeight:1.2,maxWidth:480}}>
          Five reasons brands <em style={{color:"var(--gold)",fontStyle:"italic"}}>choose Vision9</em></h2>
      </div>
      <div className="diff-list">
        {[{n:"01",t:"Strategy-first mindset with business outcomes at the core",d:"d1"},
          {n:"02",t:"Integrated digital, content, and offline branding execution",d:"d2"},
          {n:"03",t:"Industry-specific experience across high-impact sectors",d:"d3"},
          {n:"04",t:"International-quality standards and transparent reporting",d:"d4"},
          {n:"05",t:"Long-term partnerships over short-term campaigns",d:""},
        ].map((item,i)=>(
    ...
    <section className="cta">
      ...
      <div className="cta-orn rv"><span/>Ready to grow?<span/></div>
      <h2 className="cta-h rv d1">Let's Build Brands That <em>Perform</em></h2>
      <p className="cta-sub rv d2">Partner with Vision9 to move from ideas to execution — and from execution to measurable growth.</p>
      <div className="cta-btns rv d3">
        <a href="#" className="btn-gold">Book a Strategy Call</a>
        <a href="#" className="btn-out">Contact Us</a>
      </div>
    </section>
  </>)
}